...
function getAdvanceHTML(typeOfSearch,title,year){

  var page = 1;
  var url = "http://www.omdbapi.com/?s="+ title +"&y="+ year +"&plot=short&r=json&type=" + typeOfSearch + "&page=" + page; /*El tipo de búsqueda, videojuego, pelicula,serie*/
  var html ="";
  var maxSize;
  var posterError;
  switch(typeOfSearch){
