$(document).ready(function(){
    ...
    $("#enviaDatos").click(function() {
      if(getSearch() != ""){
            ...
            location.href ="/YourMedia/View/search.php?title="+getSearch()+"&advanceSearch=none"+"&year="+$("#year").val(); 
            }
            else if($('#movieRadio').is(':checked')) { 
                location.href ="/YourMedia/View/search.php?title="+getSearch()+"&advanceSearch=movie"+"&year="+$("#year").val(); 

            }
            else if($('#seriesRadio').is(':checked')) { 
                location.href ="/YourMedia/View/search.php?title="+getSearch()+"&advanceSearch=series"+"&year="+$("#year").val(); 
            }
            else{
                location.href ="/YourMedia/View/search.php?title="+getSearch()+"&advanceSearch=game"+"&year="+$("#year").val(); 
            }
                      }
    });
...
function showMoreInfo(){
  var id = $("#mediaId").html();
  location.href = "/YourMedia/View/media.php?id="+id;
}