<div class="detail" id="detailsOfMedia" style="display: none;">
    <svg class="close">
      <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#close"></use>
    </svg>
    <div class="movie">
      <img src="http://ia.media-imdb.com/images/M/MV5BMTYzMzM4NzI4Ml5BMl5BanBnXkFtZTgwODcxNDg1NjE@._V1_SX300.jpg" alt="" class="poster active" style="top: 63px; left: 28px; width: 300px; height: 445px;">
    ...
    <div id="mediaId" hidden="">undefined </div><button class="play" id="buttonPlay" onclick="showMoreInfo()">
  ...
  <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" style="display:none;">
        ...
        <symbol id="ico-search">
          <path fill-rule="evenodd" clip-rule="evenodd" fill="#363a47" d="M14.769,14.769c-0.342,0.342-0.896,0.342-1.237,0l-3.756-3.756
                                                                          ...
                                                                          c-1.708,1.708-1.708,4.479,0,6.188c1.709,1.708,4.479,1.708,6.188,0C10.927,7.51,10.927,4.74,9.219,3.032z"></path>
        </symbol>
      </svg>
    ...
    <script src='https://cdnjs.cloudflare.com/ajax/libs/jquery-easing/1.3/jquery.easing.min.js'></script>
        ...
        <script src="/YourMedia/js/index.js"></script>